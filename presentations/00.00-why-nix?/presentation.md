...
# Legacy and Modern Nix Commands

- There are two versions of Nix, traditional/legacy/channels and flakes.

  - Both co-exist at the same time. You can tell the difference with the syntax
    and commands you are using.

  - Legacy commands are still used but they're getting deprecated at glacial
    speeds.
...
# [Nix Channel branches/versions] (https://channels.nixos.org/).

The `unstable` channel is versioned after the next version, as of this writing,
that version is set to `25.11`.
